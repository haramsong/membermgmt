...
<!--                                    여자 radio button-->
                            ...
                            <tr>
                                ...
                                <td align="left" width="200"><input type="date" size="35" class="inph" name="start_date" value="<?php echo $board['start_date']; ?>" placeholder="시작일" required>
                                    <span style="background-color: white; margin-left: 30px;" onclick="window.open('/member_time.php?member_id=<?php echo $board['member_id']; ?>', 'member', 'width=495,height=900,top=200,left=500,resizable=no');">내역 보기</span></td>
                            </tr>
                            <tr>
