                    ...
                    <div class="margin-control">
                        ...
                        <table cellspacing="0" height="300">
                            ...
                            <tr>
                                ...
                                <td align="left" width="200"><input type="date" size="35" id="due_date" class="inph" name="due_date" value="" required></td>
                            </tr>
                        </table>
...
<script>
    ...
    document.body.addEventListener('change', function (e) {
        ...
        switch (target.id) {
            ...
            {
            $num = $board['member_id'];
            $sql3 = mq("select * from time_manage where member_id = '".$num."'");
            $board1 = $sql3 -> fetch_array();
