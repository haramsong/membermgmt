...
<!-- 상세정보-->
                ...
                if(k == undefined) {
                 ...
                 let url_code2 = `/member_change_ehs.php?member_id=${k}`;
...
<!--                <th width="100">최초 등록일</th>-->
            ...
            $sql = mq("select a.member_id, a.name, a.phone_number, b.type, b.start_date, b.due_date, b.doc_source, b.type_source 
            ...
            while($board = $sql->fetch_array())
            {
                ...
                document.getElementById(<?php echo $board['member_id']; ?>).style.backgroundColor = '#C8C8C8';" 
				    id="<?php echo $board['member_id']; ?>"
                    value="<?php echo $board['member_id']; ?>" 
					data_date="<?php echo $board['due_date']; ?>">
                    <td width="40"><span class="
                    <?php echo $status; ?>
                    "></span></td><td width="80">
                    <?php echo $board['member_id']; ?>
                    </td><td width="100">
                    <?php echo $board['name']; ?>
                    </td><td width="110" >
                    <?php echo $board['phone_number']; ?>
                    </td><td width="100">
                    <?php echo $board['start_date']; ?>
                    </td><td width="100">
                    <?php echo $board['due_date']; ?></td></tr></tbody>
